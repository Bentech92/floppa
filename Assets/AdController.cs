...
{
    private const string MaxSdkKey = "dKghKS8EIoKOutg15-zhPGrhSA_DGWwqQVJCLSZVlqBTvw_vNLJ0b7fT5ydEsP0u6z_80Thq4_Cfd82TuTc2nJ";
    private  string InterstitialAdUnitId = "58aac84f999c3b9d";
    private const string RewardedAdUnitId = "7fde7c9e75564bae";
    private const string RewardedInterstitialAdUnitId = "ENTER_REWARD_INTER_AD_UNIT_ID_HERE";
    private const string BannerAdUnitId = "679186e5b5b2cbcc";
    private const string MRecAdUnitId = "569dbedfc03c4407";
    ...
    public static AdController Instance
    {
        ...
        {
            if (instance == null)
                instance = GameObject.FindObjectOfType(typeof(AdController)) as AdController;
    ...
    public void InitializeRewardedInterstitialAds()
    {
        // Attach callbacks
